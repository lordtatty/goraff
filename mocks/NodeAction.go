...
func (_m *NodeAction) Do(s *goraff.Node, r *goraff.ReadableGraph, triggeringNodeID string) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(*goraff.Node, *goraff.ReadableGraph, string) error); ok {
...
func (_c *NodeAction_Do_Call) Run(run func(s *goraff.Node, r *goraff.ReadableGraph, triggeringNodeID string)) *NodeAction_Do_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*goraff.Node), args[1].(*goraff.ReadableGraph), args[2].(string))
	})
	return _c
}
...
func (_c *NodeAction_Do_Call) RunAndReturn(run func(*goraff.Node, *goraff.ReadableGraph, string) error) *NodeAction_Do_Call {
	_c.Call.Return(run)
	return _c
}
