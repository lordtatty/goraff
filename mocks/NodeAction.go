...
func (_m *NodeAction) Do(s *goraff.StateNode, r *goraff.GraphStateReader, triggeringNodeID string) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(*goraff.StateNode, *goraff.GraphStateReader, string) error); ok {
...
func (_c *NodeAction_Do_Call) Run(run func(s *goraff.StateNode, r *goraff.GraphStateReader, triggeringNodeID string)) *NodeAction_Do_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*goraff.StateNode), args[1].(*goraff.GraphStateReader), args[2].(string))
	})
	return _c
}
...
func (_c *NodeAction_Do_Call) RunAndReturn(run func(*goraff.StateNode, *goraff.GraphStateReader, string) error) *NodeAction_Do_Call {
	_c.Call.Return(run)
	return _c
}
